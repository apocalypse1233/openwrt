...
VERSION_NUMBER:=$(if $(VERSION_NUMBER),$(VERSION_NUMBER),20.12.6)

VERSION_CODE:=$(call qstrip,$(CONFIG_VERSION_CODE))
VERSION_CODE:=$(if $(VERSION_CODE),$(VERSION_CODE),r17743-61ac1562b3)

VERSION_REPO:=$(call qstrip,$(CONFIG_VERSION_REPO))
VERSION_REPO:=$(if $(VERSION_REPO),$(VERSION_REPO),http://downloads.freewrt.tk/releases/20.12.6)
